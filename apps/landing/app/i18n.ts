...
export const strings: Record<Lang, Strings> = {
  en: {
    ...
    hero: {
      ...
      sub: "22 tools. 60 top HL traders pre-seeded from the live public leaderboard. A regime classifier that calls short squeezes from organic rallies. Zero backend, zero accounts, zero config — ask 'are HL whales long BTC right now' and get an answer before your coffee is done.",
  ...
  zh: {
    ...
    hero: {
      ...
      titleAccent: "Hyperliquid。",
      sub: "22 个工具 · HL 官方 leaderboard 前 60 位真实交易员已内置 · regime 分类器能分清「空头挤压」和「自然上涨」 · 零后端 · 零账户 · 零配置 —— 直接问「HL 大佬现在多还是空 BTC」,咖啡没凉就出答案。",
      cta: "30 秒装好",
